...
import { ArrowRight, Sparkles, Bookmark, FolderTree, Tag } from 'lucide-react';
...
const heroStats: { label: string; value: string }[] = [
    { label: 'Liens sauvegardés', value: '∞' },
    { label: 'Projets organisés', value: '500+' },
    { label: 'Tags utilisés', value: '2k+' },
];
...
export function Hero() {
    ...
    return (
        <section
            ...
            role="region"
            aria-label="Hero gestion de ressources"
        >
            {/* fond avec dégradés */}
            ...
            {/* image droite — dashboard / organisation */}
            <div className="absolute inset-y-0 right-0 z-[5] hidden w-[52%] lg:block">
                <img
                    ...
                    alt="Interface de gestion de ressources numériques"
            ...
            <div className="relative z-20 mx-auto w-full max-w-7xl px-6 py-24 md:px-8 lg:px-12">
                ...
                >
                    ...
                    >
                        Plus jamais de liens perdus. Un dashboard minimaliste
                        pour sauvegarder, taguer et rechercher instantanément
                        vos ressources par projet.
                    </motion.p>
